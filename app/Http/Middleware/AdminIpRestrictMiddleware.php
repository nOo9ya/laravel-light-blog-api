...
class AdminIpRestrictMiddleware
{
    ...
    {
        // 관리자 패널 접근 시도 로그 (보안상 중요)
        \Log::warning('Admin Panel IP Access Denied', [
            'ip' => $clientIp,
        ...
        return response()->json([
            ...
            'error' => [
                ...
                'message' => '관리자 패널에 대한 접근이 거부되었습니다. 허용되지 않은 IP 주소입니다.',
                'details' => [
                    'ip' => $clientIp,
                    'timestamp' => now()->toISOString(),
                    'note' => '이 접근 시도가 기록되었습니다.'
                ]
            ]
        ], 403);
    }
